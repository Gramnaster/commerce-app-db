...
json.pagination do
  ...
  json.current_page params[:page].to_i > 0 ? params[:page].to_i : 1
  json.per_page params[:per_page].to_i > 0 ? params[:per_page].to_i : 20
  json.total_pages (@total_count.to_f / (params[:per_page].to_i > 0 ? params[:per_page].to_i : 20)).ceil
end
